...
def main():
	...
	if len(sys.argv)>2:
		...
		path = re.match('(.+)(\..*?\Z)', sys.argv[1]).groups()[0]+'.txt'
	with open(path, 'wb') as f:
		f.write(root.dumps().encode('UTF-8'))
